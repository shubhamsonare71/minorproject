...
public class Header extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
       ...
       String username = (String)session.getAttribute("user name"); 
        ...
        out.println("<a class=\"navbar-brand js-scroll-trigger\" href=\"#page-top\">"+username+"</a>");
...
//        Menu
        ...
        out.println("</li>");
        out.println("<li class=\"nav-item\">");
        out.println("<a class=\"nav-link js-scroll-trigger\" href=\"Profileservlet\">Profile</a>");
        out.println("</li>");
        out.println("<li class=\"nav-item\">");
        out.println("<a class=\"nav-link js-scroll-trigger\" href=\"Logout\">Logout</a>");
        out.println("</li>");
        out.println(" </ul>");
        out.println(" </div>");
        out.println("</div>");
        ...
        out.println("<div class=\"intro-heading text-uppercase\">"+username+"</div>");
        out.println("</div>");
        out.println("</div>");
        out.println("</header>");
